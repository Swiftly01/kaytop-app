  ...
  return (
    <div className="drawer-content">
      <div className="container h-full px-5 pt-4 mx-auto max-w-7xl">
        ...
        <div className="flex justify-between px-5 py-8 bg-white">
          <div>
        ...
        <div className="p-5 my-5 bg-white ">
          ...
          <div className="drawer drawer-end">
            ...
            <div className="z-40 drawer-side">
              ...
              ></label>
              <ul className="z-50 min-h-full p-4 menu bg-base-200 w-200">
                <h1 className="text-center">Payment Schedule</h1>
                <Table />
              </ul>
            </div>
          </div>
