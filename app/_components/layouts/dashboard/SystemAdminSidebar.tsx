...
const menuItems: MenuItem[] = [
  ...
  },
  {
    ...
    label: 'Branches',
    icon: BranchesIcon,
    href: '/dashboard/system-admin/branches',
  },
  {
    id: 'credit-officers',
    label: 'Credit Officers',
    icon: CreditOfficersIcon,
    href: '/dashboard/system-admin/credit-officers',
  },
  {
    id: 'customers',
    label: 'Customers',
    icon: CustomersIcon,
    href: '/dashboard/system-admin/customers',
  },
  {
    id: 'loans',
    label: 'Loans',
    icon: LoansIcon,
    href: '/dashboard/system-admin/loans',
  },
  {
    id: 'reports',
    label: 'Reports',
  ...
  },
  {
    ...
    label: 'Settings',
    icon: SettingsIcon,
    href: '/dashboard/system-admin/settings',
  },
];
