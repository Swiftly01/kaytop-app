 ...
 */
export function exportReportDetailsToCSV(reportData: {
  reportId: string;
  creditOfficer: string;
  branch: string;
  email?: string;
  ...
  const data = [
    { field: 'Report ID', value: reportData.reportId },
    { field: 'Credit Officer', value: reportData.creditOfficer },
    { field: 'Branch', value: reportData.branch },
    { field: 'Email', value: reportData.email || 'N/A' },
    { field: 'Report Type', value: reportData.reportType || 'N/A' },
    { field: 'Status', value: reportData.status || 'N/A' },
    { field: 'Loans Disbursed', value: reportData.loansDispursed ?? 'N/A' },
    { field: 'Loans Value Disbursed', value: reportData.loansValueDispursed || 'N/A' },
    { field: 'Savings Collected', value: reportData.savingsCollected || 'N/A' },
    { field: 'Repayments Collected', value: reportData.repaymentsCollected ?? 'N/A' },
    { field: 'Date Sent', value: reportData.dateSent },
    { field: 'Time Sent', value: reportData.timeSent },
  ];
  
  downloadCSV(data, `report-details-${reportData.reportId}`, ['field', 'value']);
}

/**
 * Print report details
 */
export function printReportDetails(reportData: {
  reportId: string;
  creditOfficer: string;
  branch: string;
  email?: string;
  ...
  const html = `
    ...
    <html>
    <head>
      <title>Report Details - ${reportData.reportId}</title>
      <style>
        body {
          font-family: 'Open Sauce Sans', -apple-system, BlinkMacSystemFont, 'Segoe UI', sans-serif;
          padding: 40px;
    ...
    <body>
      ...
      <div class="section">
        <div class="info-grid">
          <div class="field">
            <div class="label">Report ID</div>
            <div class="value">${reportData.reportId}</div>
          </div>
          <div class="field">
            <div class="label">Credit Officer</div>
            <div class="value">${reportData.creditOfficer}</div>
          </div>
          <div class="field">
            <div class="label">Branch</div>
            <div class="value">${reportData.branch}</div>
          </div>
        </div>
      </div>
      ...
      <div class="section">
        ...
        <div class="details-grid">
          ...
          <div class="field">
            <div class="label">Loans Disbursed</div>
            <div class="value value-large">${reportData.loansDispursed}</div>
          </div>
          ` : ''}
          ${reportData.loansValueDispursed ? `
          <div class="field">
            <div class="label">Loans Value Disbursed</div>
            <div class="value value-large">${reportData.loansValueDispursed}</div>
          </div>
          ` : ''}
          ${reportData.savingsCollected ? `
          <div class="field">
            <div class="label">Savings Collected</div>
            <div class="value value-large">${reportData.savingsCollected}</div>
          </div>
          ` : ''}
          ${reportData.repaymentsCollected !== undefined ? `
          <div class="field">
            <div class="label">Repayments Collected</div>
            <div class="value value-large">${reportData.repaymentsCollected}</div>
          </div>
          ` : ''}
          <div class="field">
            <div class="label">Date Sent</div>
            <div class="value">${reportData.dateSent}</div>
          </div>
          <div class="field">
            <div class="label">Time Sent</div>
            <div class="value">${reportData.timeSent}</div>
          </div>
        </div>
      </div>
